<template>
    <div>
        ...
        <nav class="fixed-top nav-recipe">            
            <ul class="nav d-flex align-items-center" style="margin: 1% 0 0 0">
            ...
            <div class="cabecalho-table">
                <label @click.stop.prevent="cabecalhoSetas[0]==false?desorganizar(recipes, 'recipeName',0):organizar(recipes, 'recipeName',0);" class="ls ls2">
                ...
                <label @click.stop.prevent="cabecalhoSetas[1]==false?desorganizar(recipes, 'recipeCode',1):organizar(recipes, 'recipeCode',1);" class="ls ls2">
                ...
                <label @click.stop.prevent="cabecalhoSetas[2]==false?desorganizar(recipes, 'recipeDescription',2):organizar(recipes, 'recipeDescription',2);" class="ls ls2">
                    <b><font class="cursor-class" color="#ffffff">
                        Descrição &nbsp;&nbsp;&nbsp;
