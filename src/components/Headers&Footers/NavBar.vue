    ...
    <div>
        ...
        <div class="menu-lateral">
            ...
            <div class="texto-menu-lateral card-header" role="tab" id="headingOne">
                <a data-toggle="collapse" href=".collapseOne" aria-expanded="true" aria-controls="collapseOne">THINGS</a>  
                <i style="" class="fa">&#xf0d7;</i></br>
                <div id="collapseOne" class="sub-menu-lateral collapse collapseOne in" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">   
                    Gerenciar Things
                </div>
                <div id="collapseOne" class="sub-menu-lateral collapse collapseOne in" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                    Criar grupo
                ...
                <a data-toggle="collapse"  href=".v-pills-receita" aria-expanded="true" router-link to="/phases"   aria-controls="collapseOne">
                    RECEITA
                </a>  
                <i style="" class="fa">
                    &#xf0d7;
                </i></br>
                <div id="v-pills-receita" class="v-pills-receita sub-menu-lateral collapse in" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                    <router-link to="/phases">
                        Cadastrar Receita
                    </router-link>
                </div>
                <div id="v-pills-receita" class="v-pills-receita sub-menu-lateral collapse in" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                ...
                <router-link to="" data-toggle="collapse" href="" aria-expanded="true" aria-controls="collapseOne">
                    TAG
                </router-link>  
                <i style="" class="fa">
                    &#xf0da;
                </i></br>
                <router-link to="/generateProducts"  data-toggle="collapse" href="" aria-expanded="true" aria-controls="collapseOne">
                    PRODUTOS
                </router-link>                          
                <i style="" class="fa">
                    &#xf0da;
                </i></br>
                <router-link to="/toolCreate" data-toggle="collapse" href="" aria-expanded="true" aria-controls="collapseOne">
                    FERRAMENTAS
                </router-link>    
                <i style="" class="fa">
                    &#xf0da;
                ...
                <div class="col-md-2 col-xs-1 p-l-0 p-r-0 collapse in" id="sidebar">
                    <div class="list-group panel">
                        ...
                        <router-link to="/toolCreate" class="list-group-item collapsed" data-parent="#sidebar">
                            ...
                            <span class="hidden-sm-down"> FERRAMENTAS</span>
                        </router-link>           
                    </div>
                </div>
                <main class="col-md-9 col-xs-11 p-l-2 p-t-2">
                    <a href="#sidebar" data-toggle="collapse"><i class="icon-navigate fa fa-navicon fa-lg" style="font-size:30px"></i></a>
                    <hr>
                </main>
            </div>
        </div>
